...
nls97 = pd.read_csv("4. OutliersMultivariate/data/nls97f.csv", low_memory=False)
nls97.set_index("personid", inplace=True)

# # look at some of the nls data
# print(nls97[['wageincome20','highestgradecompleted',
...
# print(nls97.loc[(nls97.weeksworked20==0) &
