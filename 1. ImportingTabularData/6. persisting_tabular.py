...
landtemps = \
  pd.read_csv('1. ImportingTabularData/data/landtempssample.csv',
...
extremevals.to_excel('1. ImportingTabularData/views/tempext.xlsx')
extremevals.to_csv('1. ImportingTabularData/views/tempext.csv')

# save to pickle and feather files
landtemps.to_pickle('1. ImportingTabularData/data/landtemps.pkl')
landtemps.reset_index(inplace=True)
landtemps.to_feather("1. ImportingTabularData/data/landtemps.ftr")

# load saved pickle and feather files
landtemps = pd.read_pickle('1. ImportingTabularData/data/landtemps.pkl')
landtemps.head(2).T
landtemps = pd.read_feather("1. ImportingTabularData/data/landtemps.ftr")
landtemps.head(2).T
