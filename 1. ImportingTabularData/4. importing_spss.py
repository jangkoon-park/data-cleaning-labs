...
nls97spss, metaspss = pyreadstat.read_sav('1. ImportingTabularData/data/nls97.sav')
nls97spss.dtypes
nls97spss.head()
...
nls97spss, metaspss = pyreadstat.read_sav('1. ImportingTabularData/data/nls97.sav', apply_value_formats=True, formats_as_category=True)
nls97spss.columns = metaspss.column_labels
nls97spss.columns = nls97spss.columns.\
  str.lower().\
  str.replace(' ','_').\
...
nls97stata, metastata = pyreadstat.read_dta('1. ImportingTabularData/data/nls97.dta', apply_value_formats=True, formats_as_category=True)
...
nls97sas, metasas = pyreadstat.read_sas7bdat('1. ImportingTabularData/data/nls97.sas7bdat', catalog_file='1. ImportingTabularData/data/nlsformats3.sas7bcat', formats_as_category=True)
