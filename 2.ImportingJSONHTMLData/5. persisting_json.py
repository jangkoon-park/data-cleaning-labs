...
# save to a json file
with open("2.ImportingJSONHTMLData/data/camcollections.json","w") as f:
  json.dump(camcollections, f)

# read the json file
with open("2.ImportingJSONHTMLData/data/camcollections.json","r") as f:
  camcollections = json.load(f)

pprint.pprint(camcollections['data'][0]['creators'])

# Write msgpack file
with open("2.ImportingJSONHTMLData/data/camcollections.msgpack", "wb") as outfile:
    packed = msgpack.packb(camcollections)
    outfile.write(packed)

# Read msgpack file
with open("2.ImportingJSONHTMLData/data/camcollections.msgpack", "rb") as data_file:
